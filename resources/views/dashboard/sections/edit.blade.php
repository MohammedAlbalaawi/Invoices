...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">قائمة الإعدادت</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ تعديل قسم</span>
            </div>
        </div>
        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <a class="btn ripple btn-primary"  href="{{route('sections.index')}}">عرض الأقسام</a>
                </div>
                ...
                <div class="card-body">
                        <form action="{{ route('sections.update', $model->id)}}" method="post">
                            @csrf
                            @method('put')
